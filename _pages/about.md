...
<div class="paper-box paper-box--mora">
  ...
  <div class="paper-box-text">
    ...
    <p class="paper-role"><strong>My role:</strong> Post-training for real-time responsiveness without style drift. Sub-200ms style switching, ~300ms end-to-end with network.</p>
